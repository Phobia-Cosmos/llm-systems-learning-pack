...
![SGLang SOTA Performance Loop](https://files.mdnice.com/user/59/c9444feb-ea08-4229-9176-d8b5620be06d.png)
...
![KDA-Pilot B200 diffusion kernel results](https://files.mdnice.com/user/59/6523f5bb-3e0a-432d-8897-3494b9119cb4.png)

图 2：KDA-Pilot 在 B200 上跟踪了 10 个 SGLang diffusion kernel task。大部分行给出 KDA-Pilot benchmark ledger 里的 wall-geomean speedup；这里的 wall time 包含 Python dispatch、wrapper、kernel launch 和 `cuda.synchronize()` 能观察到的同步开销，比单纯 kernel device time 更接近真实调用路径。
